        ...
        <div className='home-container col-12'>
            ...
            <div className='home offset-1 col-10'>
                <div className='row'>
                    ...
                    <Link className="item" to='/Klavesy' onClick={() => callback('Klavesy', '/Images/klavesy.jpg')} >
                    ...
                    <Link className="item" to='/Akordeony' onClick={() => callback('Akordeony', '/Images/akordeon.jpg')}>
                        <img src={Akordeon} alt='akordeon obrazok'/>
                        <p>Akordeóny</p>
                    </Link>
                    <Link className="item" to='/Prislusenstvo' onClick={() => callback('Prislusenstvo', '/Images/sluchadla.jpg')}>
