...
Route::middleware('auth:sanctum')->post('/handleRelevant', [ProduktController::class, 'handleRelevant']);
...
Route::middleware('auth:sanctum')->get('/getUsers', [AuthController::class, 'getUsers']);
